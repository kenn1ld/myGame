...
private:
	...
	bool needsPathUpdate(const sf::Vector2f& playerPosition) const;
	sf::Vector2f directionToTarget(const sf::Vector2i& targetNode, const GameWorld& world) const;  // New function to calculate direction
